...
class ArticleController extends Controller {
    ...
    public function listerArticle($debut, $page): void {
        $this->renderJson( ['articles' => $this->articleModel->findAll($debut, nbElementBypage), 'page' => $page]);
    }
