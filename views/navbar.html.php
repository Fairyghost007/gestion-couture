    ...
    <div class="flex justify-evenly  items-center  w-full p-4 ">
        <div class="flex items-center justify-between flex-row w-4/5 ">
            ...
            <div class="  items-center  ml-16">
                <a href="<?=WEBROOT?>/?controller=security&action=logout" class="text-white  bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Logout</a>
            </div>
        </div>
    </div>
</nav>