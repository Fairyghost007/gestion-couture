...
class TypeController extends Controller {
    ...
    public function listerType(int $debut, int $page): void {
        $this->renderJson(['types' =>$this->typeModel->findAll($debut, nbElementBypage), 'page' => $page]);
    }
