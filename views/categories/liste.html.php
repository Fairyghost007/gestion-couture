    ...
    <div class="flex justify-between items-center flex-col w-11/12 p-5 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <form class="flex justify-center flex-row items-center gap-4 w-full mx-auto mb-2 bg-gray-700 border border-gray-600 px-3 pt-2 rounded-lg" action="<?= WEBROOT ?>" method="post">
            <div class="mb-5 w-full">
                ...
                <input type="text" name="nomCategorie" id="nomCategorie" class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-50 dark:border-gray-300 dark:placeholder-gray-900 dark:text-gray-900 dark:focus:ring-blue-500 dark:focus:border-blue-500 <?= \App\core\add_class_invalid('nomCategorie'); ?>" />
