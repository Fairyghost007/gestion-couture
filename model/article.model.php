...
class ArticleModel extends Model
{
    ...
    {
        return $this->executeInsert("INSERT INTO article (libelle, qteStock, prixAppro, typeId, categorieId) 
    ...
    {
        return $this->executeSelectId("SELECT * FROM article WHERE id = :id",$id);
    }

    public function delete(int $id): bool
    {
        return $this->executeDelete("DELETE FROM article WHERE id = :id",$id);
    }
    ...
    {
        return $this->executeSelectNbrOfElement("SELECT COUNT(id) as nbrElements FROM article");
    }
}
